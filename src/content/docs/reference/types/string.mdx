...
string .. string: string -- \[Concatenation](#concatenation)
string ..= string

-- \[Comparison Operators](#comparison-operators) (Lexicographical order based on each ASCII byte, e.g. 'A' < 'a', '420' < '69', etc.)
...
-- \[Byte and Character Operations](#byte-and-character-operations)
...
-- \[Related ll.* String Functions](#related-ll-string-functions) (UTF8 friendly)
...
<Attribution
	...
	author="2015–2020 Lua.org, PUC-Rio"
	license="MIT"
/>
